 ...
 * @UniqueEntity(
 *   fields={"email"},
 *   message="Bu email adresi daha önce kullanılmış."
 * )
...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     * @Assert\Length(max=4096, maxMessage="Your password cannot be longer than {{ limit }} characters", min=6, minMessage="Your password must be at least {{ limit }} characters long")
     ...
     * @Assert\Length(max=45, maxMessage="Your name cannot be longer than {{ limit }} characters", min=2, minMessage="Your name must be at least {{ limit }} characters long")
     */
    private $name;

    /**
     * @Assert\NotBlank(message = "Please enter a surname")
     * @Assert\Length(max=45, maxMessage="Your surname cannot be longer than {{ limit }} characters", min=2, minMessage="Your surname must be at least {{ limit }} characters long")
     * @ORM\Column(type="string", length=45)
     */
    private $last_name;
    ...
    public function getVimoeApiKey(): ?string
    {
        return $this->vimoe_api_key;
    }

    public function setVimoeApiKey(?string $vimoe_api_key): self
    {
        $this->vimoe_api_key = $vimoe_api_key;
